...
export class StudentComponent {
  ...
  defaultDp = "../../assets/img/no-picture.png"
  ...
  //AllStudentList: any = [];
  //keyword = this.AllStudentList.StudentName;
  //getAllStudentList() {
  //  this.dataLoading = true;
  //  this.service.getAllStudentList({}).subscribe(r1 => {
  //    let response = r1 as any
  //    if (response.Message == ConstantData.SuccessMessage) {
  //      this.AllStudentList = response.AllStudentList;
  ...
  editDp(event: any) {
    ...
    if (this.fileToUpload.size > 50000 && this.fileToUpload.size < 20000) {
      this.toastr.error("File size should be between 20 Kb and 50 KB.");
      this.fileToUpload = null;
      return;
    }
  }
